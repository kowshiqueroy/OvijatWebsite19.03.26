...
$menuItems = [
    ...
    ['icon' => 'fa-chart-pie', 'label' => 'Reports', 'link' => 'detailed_report.php'],
      ['icon' => 'fa-box', 'label' => 'Net Sale', 'link' => 'sales_summary.php'],
        ['icon' => 'fa-chart-pie', 'label' => 'Compare', 'link' => 'compare_trends.php'],
