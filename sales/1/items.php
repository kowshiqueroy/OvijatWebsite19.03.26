            ...
            <div class="table-responsive">
                <table class="table-simple">
                    ...
                    <tbody>
                        ...
                        // Count Total
                        $stmt_count = $conn->prepare("SELECT COUNT(*) as total FROM items WHERE company_id = ?");
                        ...
                        // Fetch Data
                        $stmt = $conn->prepare("SELECT * FROM items WHERE company_id=? ORDER BY id DESC LIMIT ? OFFSET ?");
