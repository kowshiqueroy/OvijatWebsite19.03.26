...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        .input-wrapper input { flex: 1; background: none; border: none; color: var(--gemini-input); font-size: 16px; outline: none; padding: 10px 0; min-width: 0; }
...
<body>
    ...
    function getCam(msg, isSent) {
        ...
        const arr = isSent ? ["Explain React Virtual DOM...", "Python data scraping...", "SQL query for salary...", "সুন্দর করে সাজিয়ে কোড দাও।", "এই লেখা টা দেখো, আর হিসেব করে দাও, Mughal History summary..."] : ["The Virtual DOM is a copy...", "Use BeautifulSoup in Python...", "SELECT MAX(salary) FROM...", "সকল এ আই এজেন্ট ব্যস্ত আছে। ধন্যবাদ।", " এভাবে সাজিয়ে দিলে চলবে কিনা আমাকে জানান, আমি নিশ্চিত হয়ে নতুন দিচ্ছি। The Empire was founded..."];
