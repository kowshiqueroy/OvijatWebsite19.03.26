...
<?php elseif ($submitted && !empty($empIds)): ?>

    <!-- ── Section A: Salary History ─────────────────────────────────────────── -->
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="bi bi-currency-dollar me-2"></i>Salary History
                <span class="badge bg-secondary ms-2"><?php echo count($salaryRows); ?> records</span>
            </h5>
            <small class="text-muted"><?php echo date('M Y', strtotime($fromMonth . '-01')); ?> – <?php echo date('M Y', strtotime($toMonth . '-01')); ?></small>
        </div>
            ...
            <table class="table table-sm table-hover mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="text-center">Work / Present / Absent</th>
                ...
                <tbody>
                    <?php if (empty($salaryRows)): ?>
                        <tr><td colspan="10" class="text-center text-muted py-3">No salary records found</td></tr>
                    <?php else: ?>
                        <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo $row['working_days']; ?> / <?php echo $row['present_days']; ?> / <?php echo $row['absent_days']; ?></td>
                                <td class="text-end"><?php echo number_format($row['gross_salary'], 2); ?></td>
                                <td class="text-end text-danger"><?php echo number_format($row['pf_deduction'], 2); ?></td>
                                <td class="text-end text-success"><?php echo number_format($row['bonus'], 2); ?></td>
                                <td class="text-end fw-bold"><?php echo number_format($row['net_payable'], 2); ?></td>
                        ...
                        <tr class="table-light fw-bold">
                            <td colspan="5" class="text-end text-muted small">
                                <?php echo htmlspecialchars($rows[0]['emp_name']); ?> subtotal (<?php echo count($rows); ?> months):
                            </td>
                            <td class="text-end"><?php echo number_format($empTotals['gross'], 2); ?></td>
                            <td class="text-end text-danger"><?php echo number_format($empTotals['pf'], 2); ?></td>
                            <td class="text-end text-success"><?php echo number_format($empTotals['bonus'], 2); ?></td>
                            <td class="text-end"><?php echo number_format($empTotals['net'], 2); ?></td>
                            <td></td>
                        </tr>
                        <?php
                ...
                <tfoot class="table-dark fw-bold">
                    <tr>
                        ...
                        <td class="text-end"><?php echo number_format($grandTotals['gross'], 2); ?></td>
                        <td class="text-end"><?php echo number_format($grandTotals['pf'], 2); ?></td>
                        <td class="text-end"><?php echo number_format($grandTotals['bonus'], 2); ?></td>
                        <td class="text-end"><?php echo number_format($grandTotals['net'], 2); ?></td>
                        <td></td>
                    </tr>
                </tfoot>
                <?php endif; ?>
