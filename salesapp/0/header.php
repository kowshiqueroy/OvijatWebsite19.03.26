...
if ($_SESSION['role'] != 0)       { header("Location: ../" . $_SESSION['role']); exit; }
...
$menuItems = [
    ...
    ['section'=>'System'],
    ['icon'=>'fa-building',           'label'=>'Companies',   'link'=>'companies.php'],
    ['icon'=>'fa-users',              'label'=>'Users',       'link'=>'users.php'],
    ['icon'=>'fa-database',           'label'=>'DB Setup',    'link'=>'../setup.php'],
];
?>
<!DOCTYPE html>
<html lang="en">
