...
if ($_SESSION['role'] != 9)       { header("Location: ../" . $_SESSION['role']); exit; }
...
$menuItems = [
    ...
    ['icon'=>'fa-chart-line',         'label'=>'Sales Report',     'link'=>'reports.php'],
    ['icon'=>'fa-file-lines',         'label'=>'Net Sales Detail', 'link'=>'detailed_report.php'],
    ['icon'=>'fa-arrows-left-right',  'label'=>'Trends',           'link'=>'compare_trends.php'],
    ['section'=>'Delivery Reports'],
    ['icon'=>'fa-truck',              'label'=>'Truck Performance','link'=>'truck_report.php'],
    ['icon'=>'fa-bullseye',           'label'=>'Target Fulfillment','link'=>'target_report.php'],
    ['section'=>'Advanced'],
    ['icon'=>'fa-boxes-stacking',     'label'=>'Product Analysis', 'link'=>'product_report.php'],
    ['icon'=>'fa-store',              'label'=>'Customer Analysis','link'=>'customer_report.php'],
    ['icon'=>'fa-money-bill-trend-up','label'=>'Cash Collections', 'link'=>'cash_report.php'],
];
?>
<!DOCTYPE html>
<html lang="en">
