...
function get_nav_menu(): array {
    return [
        ...
        ['label' => 'Academic',      'icon' => 'book-half',        'url' => null, 'perm' => 'academic.view', 'children' => [
            ...
            ['label' => 'Master Routine Planner', 'url' => 'modules/academic/master_routine.php', 'perm' => 'routine.view'],
        ...
        ['label' => 'Inventory',     'icon' => 'boxes',             'url' => null, 'perm' => 'inventory.view', 'children' => [
            ...
            ['label' => 'Asset Assignments','url' => 'modules/inventory/assignments.php', 'perm' => 'inventory.manage'],
