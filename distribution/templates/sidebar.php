<div class="bg-dark border-right text-white" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush sidebar-menu">
        ...
        <a href="<?php echo BASE_URL; ?>modules/accounts/ledger.php" class="list-group-item list-group-item-action bg-dark text-white border-0 py-2">
        ...
        <div class="p-2 text-muted small text-uppercase">Inventory</div>
        ...
        <a href="<?php echo BASE_URL; ?>modules/products/damages.php" class="list-group-item list-group-item-action bg-dark text-white border-0 py-2">
            <i class="fas fa-biohazard me-2"></i> Stock Damages
        </a>
        <?php endif; ?>

        <!-- LOGISTICS -->
        <?php if (in_array($role, [ROLE_ADMIN, ROLE_MANAGER, ROLE_ACCOUNTANT])): ?>
        <div class="p-2 text-muted small text-uppercase">Logistics</div>
        <a href="<?php echo BASE_URL; ?>modules/delivery/index.php" class="list-group-item list-group-item-action bg-dark text-white border-0 py-2">
            <i class="fas fa-truck me-2"></i> Truck Loads
        </a>
        <?php endif; ?>
        ...
        <a href="<?php echo BASE_URL; ?>modules/sales/index.php" class="list-group-item list-group-item-action bg-dark text-white border-0 py-2">
            <i class="fas fa-file-invoice me-2"></i> <?php echo ($role == ROLE_CUSTOMER || $role == ROLE_SR) ? 'My Sales' : 'All Sales'; ?>
        </a>

        <!-- MASTERS (General Viewing) -->
